...
const LandingProductCard = (props) => {
	...
	return (
		<Link
			href={`/product/${slug}`}
			className={`${gridColumn} h-full hover:shadow-lg hover:shadow-slate-200 rounded-2xl overflow-hidden transition-all duration-300 ease-in-out`}
		>
			<div className="bg-gray-900 p-4 md:p-6 h-full flex flex-col gap-y-8">
				<div className="">
					<h2
