  ...
  return (
    <div className="min-h-screen">
      <div className="py-8 lg:pt-20 ">
        <div className="py-11 bg-text-primary-blue">
      ...
      <div className="mx-auto max-w-2xl sm:pb-6 lg:max-w-7xl xl:max-w-screen-xl overflow-hidden min-h-screen lg:pb-8">
        <div className="w-full grid grid-cols-1 md:grid-cols-2 bg-white md:gap-x-6">
          ...
          <div className={`flex flex-col gap-y-3 ${roboto.className}`}>
            <h2 className="text-lg leading-none">
              {product?.generalCategoryTitle}
            </h2>
            <h1
              className={`text-2xl md:text-6xl font-bold text-text-primary-blue ${oswald.className}`}
            >
              {product?.title}
            </h1>
