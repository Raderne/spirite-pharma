        ...
        <div className="mx-auto max-w-2xl px-4 sm:pb-6 lg:max-w-7xl xl:max-w-screen-xl bg-white min-h-screen lg:pb-8 lg:pt-24 mb-12">
          ...
          <div className="md:grid grid-cols-1 md:grid-cols-6 w-full gap-x-4">
            <div className="order-1 col-span-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="col-span-2 p-4 flex flex-col gap-y-3">
                ...
                <p className="text-md md:text-lg ml-4">
                  ...
                  <br />
                  <br />
                  C&apos;est en se concentrant sur la recherche de nouveaux
                  actifs 100% naturels, d&apos;origine végétale que nous nous
                  efforçons chaque jour de faire ce qui importe le plus aux
                  patients: accélérer l&apos;accès au traitement et trouver des
                  solutions pour répondre aux besoins non -satisfaits.
                  <br />
                  <br />
                  Nos patients font confiance à nos produits, et nous croyons
                  que cette confiance doit être gagnée chaque jour. Nous nous
                  ...
                  son R&D, le laboratoire se maintient à la pointe de la
                  recherche scientifique offrant des produits de qualité prouvée
                  et reconnue par le corps médical et pharmaceutique. Ainsi,
                  nous intervenons dans plusieurs domaines notamment la
                  dermatologie, la gynécologie, la pédiatrie et autres.
                </p>
              </div>
            </div>
            ...
            <div className="order-4 col-span-6 p-4 flex flex-col gap-y-3">
              ...
              <p className="text-md md:text-lg ml-4">
                Notre mission est de fournir des médicaments de qualité à des
                prix abordables.
                <br />
                Nous respectons les normes les plus élevées d&apos;intégrité et
                de transparence dans toutes nos interactions avec nos
                partenaires.
              </p>
